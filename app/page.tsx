      ...
      <div id="home">
        ...
        <div className="main-content">
          ...
          <div className="main-text">
            <h1 className="hover-effect hover-effect--bg-south" style={{ position: "absolute", top: "60px", left: "60px", margin: "0 0 20px 0", maxWidth: "60%", zIndex: 10 }}>Zack Woo is a Dallas-based artist/coder exploring systems, self-generating processes, and digital Autopoeisis through technology. </h1>
            <h3 className="hover-effect hover-effect--bg-south" style={{ position: "absolute", top: "140px", left: "60px", margin: "0", maxWidth: "60%", zIndex: 10 }}>In addition to his independent work, he collaborates across art and music to create transformative experiences. </h3>
          </div>
