      ...
      <div id="home">
        ...
        <div className="main-content">
          ...
          <div className="main-text">
            ...
            <h3 className="subtitle-text" style={{ position: "relative", top: "55px", maxWidth: "55vw", fontWeight: "350" }}>In addition to his independent work, he collaborates across art and music to create transformative web-based experiences. </h3>
          </div>
